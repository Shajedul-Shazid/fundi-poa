    ...
    <div class="wrapper wrapper--w790">
        <div class="card card-5">
            <div class="card-heading">
                <?php echo $msg;?>
                <h2 class="title">ADVERTISEMENTS  - ​ ​PAGE REGISTRATION CONTENT</h2>
            </div>
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                       <h3> please  uploads an advertisement picture </h3></br>
                    <div class="form-row">
                    ...
                    <div>
                        <button class="btn btn--radius-2 btn btn-info" type="submit" name="submitphoto">Register</button>
                    </div>
                </form>
