        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <?php echo $msg;?>
                    <h2 class="title">FUNDI - ​ ​PAGE REGISTRATION CONTENT</h2>
                </div>
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-row m-b-55">
                            <div class="form-row">
                                <label for="validationCustom01" class="name">Name</label>
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5 form-control" id="validationCustom01" type="text" name="first_name">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row ">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5 form-control" type="text" name="job_title">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5 form-control" type="number" name="mobile_number">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5 form-control" type="text" name="skills">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5 form-control"  type="file" name="photoo">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5 form-control"  type="file" name="photooo">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div>
                            <button class="btn btn--radius-2 btn btn-info" type="submit" name="submitFundi">Register</button>
                        </div>
                    </form>
                </div>
            </div>
