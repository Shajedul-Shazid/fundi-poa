...
$resultForSelectUpdate=$modelObjSelectForUpdate->fundiPageSelectForUpdate($ID);
$dataSelectForUPdate=$resultForSelectUpdate->fetch_assoc();

if(isset($_POST['fundiUpdate'])){
    $modelObjForFundiUPdate=new model();
    $resultFundiUpdate=$modelObjForFundiUPdate->fundiUpdate($ID);
    if($resultFundiUpdate==true){
        header("location:fundiPage.php?msg=$msg");
    }else{
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="indexAdmin.php">
            ...
            <div class="sidebar-brand-text mx-3">Fundi-poa Admin</div>
        </a>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Fundi form updated page</h1>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $dataSelectForUPdate['first_name']; ?>" name="first_name" class="form-control" type="text">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Job title</label>
                                    <input value="<?php echo $dataSelectForUPdate ['job_title']; ?>" name="job_title" class="form-control" type="text">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Mobile Number</label>
                                    <input value="<?php echo $dataSelectForUPdate ['mobile_number']; ?>" name="mobile_number" class="form-control" type="text">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                           ...
                           <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $dataSelectForUPdate ['certifications']; ?>" name="certifications" class="form-control" type="text">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Skills</label>
                                    <input value="<?php echo $dataSelectForUPdate ['skills']; ?>" name="skills" class="form-control" type="text">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input name="fundiUpdate" value="UPDATE" class="form-control btn btn-success" type="submit">
                                </div>
                            </div>
                        </div>
                    </form>
